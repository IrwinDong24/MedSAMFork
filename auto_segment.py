...
img_2d = np.load('test/npy/hedm_powder/imgs/img_0.npy')
gts = np.load('test/npy/hedm_powder/gts/img_0.npy')
img_2d = (img_2d - img_2d.min()) / np.clip(
    img_2d.max() - img_2d.min(), a_min=1e-8, a_max=None)
img_3d = np.repeat(img_2d[:, :, None], 3, axis=-1)

sam_checkpoint = "sam_vit_b_01ec64.pth"
med_sam_checkpoint = "work_dir/MedSAM/medsam_vit_b.pth"
sam_h_checkpoint = "sam_vit_h_4b8939.pth"
aps_sam_checkpoint = "work_dir/MedSAM-ViT-B-20240709-0003/medsam_model_best.pth"
